...
Giai đoạn 3 tập trung vào việc xây dựng dịch vụ thông báo và khuyến mãi. Dịch vụ thông báo sẽ cho phép hệ thống gửi thông báo đến ứng dụng di động và nhóm Zalo. Dịch vụ khuyến mãi sẽ cho phép quản trị viên tạo, chỉnh sửa và xóa các chương trình khuyến mãi với ngày bắt đầu và kết thúc.
...
- Hoàn thành 100% các yêu cầu chức năng được phân bổ cho giai đoạn 3.
...
* **Token theo dõi:** <!--START_TAGS-->[REQ-016], [DAT-008]<!--END_TAGS-->
...
* **Token theo dõi:** <!--START_TAGS-->[REQ-016]<!--END_TAGS-->
...
* **Token theo dõi:** <!--START_TAGS-->[REQ-017], [REQ-018], [DAT-009]<!--END_TAGS-->
...
* **Token theo dõi:** <!--START_TAGS-->[REQ-017], [REQ-018]<!--END_TAGS-->
